        ...
        <div className="mx-auto w-full max-w-3xl">
          {route && (
            <div className="cn-fade-in mb-2 max-h-[38dvh] overflow-y-auto rounded-2xl border border-cn-teal/40 bg-cn-paper/95 p-4 shadow-lg backdrop-blur-sm">
              <div className="mb-2 flex items-baseline justify-between gap-3">
                ...
                <button onClick={clearAll} className="text-[12px] font-medium text-cn-ink-soft underline decoration-cn-line underline-offset-4 hover:text-cn-teal-deep">
                  Clear route
                </button>
              </div>
          ...
          {noRoute && (
            <div className="mb-2 rounded-2xl border border-cn-clay/60 bg-cn-paper/95 p-4 text-[13px] leading-relaxed text-cn-ink backdrop-blur-sm">
              No cart path connects those two points. If one side is across I-95, carts cannot cross there. Try a point closer
              to the destination.
            </div>
          )}

          {/* A/B mode toggle + chips */}
